...
public class ResourceUtils {
    ...
    public static File getAssertFile (Context context, String assertName) {
        ...
        try {
            skinFiles = context.getAssets().list(SkinConfig.SKIN_FOLER_NAME);
        } catch (IOException e) {
            e.printStackTrace();
        }
        for (String fileName : skinFiles) {
//            File file = new File(ResourceUtils.geFileToListFromAssets(context), fileName);
            File file = ResourceUtils.getAssertFile(context, assertName);
            if (!file.exists()) {
